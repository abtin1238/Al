...
/// نمای اصلی ناوبری: نقشه‌ی **آنلاینِ واقعیِ تمام‌صفحه** (OpenStreetMap)
...
/// آن نقطه (از طریق OSRM روی گرافِ واقعیِ جاده‌ها) آغاز می‌شود.
...
class _NavigationScreenState extends ConsumerState<NavigationScreen> {
  ...
  void initState() {
    super.initState();
    // درخواست GPS با context بعد از build اول — دیالوگ GPS/مجوز نشون می‌ده
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        body: Stack(
          children: [
            // ---- نقشه‌ی آنلاینِ واقعیِ تمام‌صفحه ----
            Positioned.fill(
              child: OnlineMapView(
                camera: camera,
            ...
            // ---- راهنمای لمس (فقط اولین بار) — بدون متن مزاحم ----
