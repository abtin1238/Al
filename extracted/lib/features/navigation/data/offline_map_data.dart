...
const int _rows = 14;
const int _cols = 14;
const double _lat0 = 35.7380;
const double _lon0 = 51.3900;
const double _dLat = 0.0026; // ~290 متر بین گره‌ها
const double _dLon = 0.0030;
...
bool _arterialRow(int r) => r % 3 == 0;
bool _arterialCol(int c) => c % 3 == 0;
